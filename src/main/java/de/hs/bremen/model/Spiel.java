...
public class Spiel {
	...
	public void schiffePlatzieren(){
		...
		do{
			System.out.println("Bitte geben Sie an mit vielen Schiffen Sie pro Person spielen mˆchten.");
	...
	public void init(){
		...
		System.out.println("Bitte geben Sie zun‰chst die Anzahl der Spieler an");
